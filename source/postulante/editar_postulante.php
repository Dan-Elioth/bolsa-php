...
if (isset($_FILES['nuevo_archivo']) && $_FILES['nuevo_archivo']['error'] === UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($ruta_temporal, $ruta_nuevo_archivo)) {
        ...
        $sql_actualizar = "UPDATE postulacions SET seleccionado='$seleccionado',archivo='$nombre_archivo' WHERE id='$id'";
    ...
    $sql = "UPDATE postulacions SET seleccionado='$seleccionado' WHERE id='$id'";
