...
<div class="container-fluid" align="center">
    ...
    <div class="p-3 shadow-sm mb-4 d-flex align-items-center justify-content-between bg-white" style="border-radius: 0.75rem;">
        ...
        <a href="<?php echo RUTAGENERAL; ?>/source/usuario/registro_usuarios.php" class="btn btn-primary">
            ...
            <form action="" method="POST" class="filtro-form" id="filtro-form">
                <div class="form-group text-left buscar_nombre">
                    ...
                    <div class="label_select">
                        <select name="filtro_rol" id="filtro_rol" class="form-control filtro-rol-select" onchange="submitForm()">
            ...
            <table class="table table-hover table-bordered mb-0 small">
                ...
                <tbody>
                    ...
                    while ($fila = mysqli_fetch_array($registros)) {
                        ...
                        echo "'>";
                        echo "<td class='align-middle'>" . $fila['dni'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['nombres'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['apellidos'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['telefono'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['empresa_nombre'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['nombre_rol'] . "</td>";
                        echo "<td class='align-middle'>" . $fila['Estado'] . "</td>";
                    ...
                    ?>
                        ...
                        if ($fila['id_rol'] == 4) {
                        ?>
                            <button title="Autorizar" type="button" class="btn btn-primary mx-1" onclick="f_autorizar('<?php echo $fila['id']; ?>')" title="Autorizar"><i class="fas fa-user-check fa-xs"></i></button>
                        <?php
                        }
                        ?>
                        ...
                        <button onclick="eliminarUsuario('<?php echo $fila['id']; ?>')" type="button" class="btn btn-danger mx-1" title="Eliminar"><i class="far fa-trash-alt fa-xs"></i></button>
                    <?php
                        echo "</td>";
                        echo "</tr>";
                    }
